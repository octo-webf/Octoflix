...
describe('VideoLayout.vue', () => {
  ...
  context('clickable emit', () => {
    ...
    describe('player-slider-input', () => {
      ...
      it.skip('should emit moveTimeEvent with the sended value', () => {
        const clickableElement = wrapper.find(selector)
  ...
  context('displayer', () => {
    ...
    describe('title', () => {
      const selector = '[data-test=title-display]'
      ...
      it('should display the title name', () => {
        const displayableElement = wrapper.find(selector)
        expect(displayableElement.text()).toBe(title)
      })
    })
